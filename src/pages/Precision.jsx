...
const MATERIALS = [
  {
    name: "PLA+",
    best: "Prototypes, consumer, display models",
    strength: "High",
    heat: "60°C",
    flex: "Low",
    price: "₹₹",
  ...
  {
    name: "PETG",
    best: "Enclosures, outdoor, mechanical parts",
    strength: "V. High",
    heat: "80°C",
    flex: "Medium",
    price: "₹₹",
  ...
  {
    name: "ABS",
    best: "Automotive, heat-exposed, machinable",
    strength: "High",
    heat: "105°C",
    flex: "Low-Med",
    price: "₹₹₹",
  ...
  {
    name: "TPU",
    best: "Grips, gaskets, wearables, shock absorb",
    strength: "Medium",
    heat: "70°C",
    flex: "V. High",
    price: "₹₹₹",
  ...
  {
    name: "PA12 Nylon",
    best: "Jigs, fixtures, functional production",
    strength: "V. High",
    heat: "120°C",
    flex: "Medium",
    price: "₹₹₹₹",
...
const PROCESS_STEPS = [
  {
    n: "01",
    t: "File Upload",
    d: "Send us your STL, STEP, or OBJ file. We accept incomplete files too — send what you have and we'll advise.",
  },
  {
    n: "02",
    t: "CAD Review",
    d: "An engineer checks your file for printability, wall thickness issues, and tolerance risks — before we print a single layer.",
  },
  {
    n: "03",
    t: "Quote & Confirm",
    d: "You get a clear breakdown — material, quantity, finish, and lead time. Confirm and we start the same day.",
  },
  {
    n: "04",
    t: "Print & QC",
    d: "Every part is measured with digital calipers. Any deviation triggers a reprint. You get what you specified — not a near-miss.",
  },
];
  ...
  return (
    <div style={{ background: "#08070a" }}>
      ...
      <section className="yw-hero">
        ...
        <div className="eyebrow yw rv" style={{ position: "relative" }}>
          02 — Precision B2B · Engineering Grade
        </div>
        ...
        >
          ...
          >
            From rapid prototypes to production runs — engineered-grade 3D
            printing for startups, product designers, and manufacturing teams.
            Tight tolerances. Multiple materials. Real QC.
          </p>
          <button className="btn-yw" onClick={goQuote}>
            Get Quote →
          </button>
        </div>
      </section>
      ...
      >
        {[
          ...
          <div key={s.l} className="sb-item" style={{ borderColor: "#2a2208" }}>
            <div className="sb-n">
              {s.n}
              <span style={{ color: "var(--yw)" }}>{s.s}</span>
            </div>
            <div className="sb-l" style={{ color: "#3a3008" }}>
              {s.l}
            </div>
            <div className="sb-d" style={{ color: "#555" }}>
              {s.d}
            </div>
          </div>
        ))}
      ...
      <section
        className="sec-pad"
        style={{ background: "#08070a", borderColor: "#2a2208" }}
      >
        <div className="sh rv" style={{ borderColor: "#2a2208" }}>
          <h2 className="sh-t">Services</h2>
          <span
            className="sh-s"
            style={{ color: "#3a3008", filter: "brightness(7)" }}
          >
            04 — What We Offer
          </span>
        </div>
        <div
          className="yw-cap-grid"
          style={
            isMobile
        ...
        >
          ...
          {/* CTA card */}
          <div
            className="yc yw-cta rv d2"
            style={{ backgroundColor: "#f0c020" }}
          >
            <div className="yc-n" style={{ color: "rgba(0,0,0,.3)" }}>
              Get Started
            </div>
            <div
              className="yc-name"
            ...
            <p className="yc-desc" style={{ color: "rgba(0,0,0,.3)" }}>
              Send your file. Get a quote within 2 hours. We review CAD and flag
              issues before printing.
            </p>
            <button
              className="btn-or"
      ...
      <section
        className="sec-pad"
        style={{ background: "#06060a", borderColor: "#2a2208" }}
      >
        <div className="sh rv" style={{ borderColor: "#2a2208" }}>
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
                    <span style={{ fontSize: 11, color: "#555" }}>
                      Strength:{" "}
                      <span style={{ color: "#ccc" }}>{m.strength}</span>
                    </span>
                    <span style={{ fontSize: 11, color: "#555" }}>
                      Heat: <span style={{ color: "#ccc" }}>{m.heat}</span>
                    </span>
                    <span style={{ fontSize: 11, color: "#555" }}>
                      Flex: <span style={{ color: "#ccc" }}>{m.flex}</span>
                    </span>
                    <span style={{ fontSize: 11, color: "#555" }}>
                      Price:{" "}
                      <span style={{ color: "var(--yw)" }}>{m.price}</span>
                    </span>
                  </div>
                </div>
              ))}
        ...
        >
          {PROCESS_STEPS.map((s, i) => (
            ...
            >
              ...
              <p
                style={{ fontSize: 12.5, color: "var(--g5)", lineHeight: 1.7 }}
              >
                {s.d}
              </p>
            </div>
      ...
      <footer style={{ background: "#06060a", borderTop: "1px solid #2a2208" }}>
        ...
        >
          ...
          <div
            ...
            style={{ color: "#3a3008", filter: "brightness(7)" }}
          >
            © 2025 SolidLabs · Precision B2B · Bengaluru
          </div>
        </div>
      </footer>
    </div>
