...
const GlobalStyle = createGlobalStyle`
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  body{background:${T.blk};color:${T.wht};font-family:${T.ffBody};font-weight:300;overflow-x:hidden;}
`;
...
const BsHeroLeft = styled.div`
  ...
  @media (max-width: 768px) {
    ...
    border-right: none;
    border-bottom: 1px solid rgba(230, 48, 24, 0.06);
  }
  @media (max-width: 480px) {
...
// ── Hero preview grid (inline styles → styled for responsiveness)
