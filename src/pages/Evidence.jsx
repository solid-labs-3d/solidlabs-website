...
const PROJECTS = [
  {
    ...
    visual: (
      <div style={{ display: "flex", gap: 2, margin: "8px 0" }}>
        <div
          style={{ height: 40, flex: 1, background: "#f05c1e", opacity: 0.8 }}
        />
        <div
          style={{ height: 40, flex: 1, background: "#c44820", opacity: 0.8 }}
        />
        <div
          style={{
            height: 40,
        ...
        />
        <div
          style={{ height: 40, flex: 1, background: "#f0ede6", opacity: 0.7 }}
        />
      </div>
    ),
  },
    ...
    visual: (
      ...
      >
        <svg width="120" height="60" viewBox="0 0 120 60" fill="none">
          <polygon
            points="10,40 110,40 106,20 14,20"
            fill="#1e1e1e"
            stroke="#f0c020"
            strokeWidth="1"
          />
          <polygon
            points="14,20 106,20 100,4 20,4"
            fill="#2a2a1a"
            stroke="#f0c020"
            strokeWidth=".8"
          />
    ...
    visual: (
      <div
        style={{
          height: 80,
          background: "#020408",
          border: "1px solid rgba(30,122,255,.12)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          margin: "8px 0",
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 70% 60% at 60% 40%,rgba(240,92,30,.06),transparent 70%)",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            FIELD
            <em style={{ fontStyle: "normal", color: "#f05c1e" }}>-EVIDENCE</em>
          </span>
        </div>
        ...
        >
          Real projects for real clients. We don't do renders. These are parts
          that exist in the world — shipped, installed, running.
        </p>
      </section>
